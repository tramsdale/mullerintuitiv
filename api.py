"""API for Muller Intuitiv Climate Integration bound to Home Assistant OAuth."""
...
class ConfigEntryAuth(my_pypi_package.AbstractAuth):
    """Provide Muller Intuitiv Climate Integration authentication tied to an OAuth2 based config entry."""
    ...
    def __init__(
        ...
        """Initialize Muller Intuitiv Climate Integration Auth."""
        self.hass = hass
        self.session = oauth_session
        super().__init__(self.session.token)

    def refresh_tokens(self) -> str:
        """Refresh and return new Muller Intuitiv Climate Integration tokens using Home Assistant OAuth2 session."""
